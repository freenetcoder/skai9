...
export default function HavingLiquidityRow() {
  ...
  return (
    <>
      <div className="relative mx-auto max-w-7xl px-8 py-24 sm:px-12 md:py-30 lg:px-3">
        <h2
          className={cn(
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-7 py-14 sm:px-6 md:py-30">
