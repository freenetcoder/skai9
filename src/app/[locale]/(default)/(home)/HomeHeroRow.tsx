  ...
  return (
    <>
      <div className="relative mx-auto max-w-7xl p-3">
        ...
        <div className="absolute bottom-0 right-0 -z-10 opacity-50">
          <Image
            src={OPOSClimate}
            alt="Background"
            className="h-56 w-56 sm:h-64 sm:w-64 md:h-96 md:w-96 lg:h-[512px] lg:w-[512px]"
        ...
        <div className="relative mx-auto flex max-w-3xl flex-col items-center gap-6 py-24 md:py-24 lg:max-w-4xl">
          <h1
            className={cn(
          ...
          >
            ...
            {t('(home).HomeHeroRow.subtitle2')} <br />
            {t('(home).HomeHeroRow.subtitle3')}
          </p>
          <div className="flex flex-wrap items-center justify-center gap-3">
            <Link href={`https://dexscreener.com/solana/7a1kt46lq1hduvcdnpxgmgmrmbfu2nnnx9x7e2ebqexy`}
             target="_blank"
