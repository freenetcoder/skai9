...
export default function CTARow() {
  ...
  return (
    <>
      <div className="mx-auto max-w-7xl px-6 py-16 sm:py-32 lg:flex lg:items-center lg:justify-between">
        <div>
          <h2
            className={cn(
        ...
        <div className="mt-10 flex items-center gap-x-6 lg:mt-0 lg:flex-shrink-0">
          <Link href="https://t.me/skai9sol">
            <Button>
              <FontAwesomeIcon icon={faTelegram} className="mr-2 h-5 w-5" />
